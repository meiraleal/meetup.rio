...
`,mimeType:"text/javascript"},"/$app/base/app/index.js":{content:`import p from"/$app.js";p.addModule({name:"app",path:"/$app/base/app"});
`,mimeType:"text/javascript"},"/frontend.js":{content:'import o from"/$app/types/index.js";import e from"/$app.js";import"/models/schema.js";import"/$app/cms/index.js";import"/$app/i18n/index.js";import i from"/$app/theme/index.js";import"/$app/tailwind/index.js";import"/$app/uix/app.js";import"/$app/icon-lucide/app.js";import"/controllers/index.js";import"/$app/maps/app.js";import{initAuthFrontend as n}from"/$app/auth/frontend.js";n(e),e.i18n.registerLocale("en",()=>import("/locales/en.js")),e.i18n.registerLocale("pt",()=>import("/locales/pt.js")),e.events.on("AUTH:GUEST_CONVERTED",async({guestId:t,newUserId:r})=>{await Interactions.migrateGuestData(t,r)}),e.events.on("APP:INIT",async()=>{if(e.Auth){const t=await e.Auth.restore();console.log(t?`Auth restored for: ${e.Auth.user?.name}`:"No auth session - guest mode")}i.loadTheme("nbs"),e.define("app-container",{extends:"router-ui",properties:{userId:o.number({sync:"local"})},async connected(){this.currentLang=e.i18n.getLanguage(),e.events.on("i18n:language-changed",({locale:t})=>{this.currentLang=t}),this.addEventListener("item-click",t=>{this.modalItem=t.detail.item,this.modalOpen=!0})}})});\n',mimeType:"text/javascript"},"/$app/controller/adapters/storage.js":{content:`const o=e=>typeof e=="object"&&e!==null||Array.isArray(e)?JSON.stringify(e):e,c=e=>{try{return JSON.parse(e)}catch{return e}},u=e=>t=>{const n=e.getItem(t);return n!==null?c(n):null},i=e=>(t,n)=>(e.setItem(t,o(n)),{key:t}),a=e=>t=>(e.removeItem(t),{key:t}),l=e=>()=>Object.keys(e),m=e=>t=>e.getItem(t)!==null&&e.getItem(t)!==void 0,s=e=>({has:m(e),set:i(e),remove:a(e),get:u(e),keys:l(e)}),r=new Map,d={has:e=>r.has(e),get:e=>r.get(e),set:(e,t)=>(r.set(e,t),{key:e}),remove:e=>(r.delete(e),{key:e}),keys:()=>r.keys()},g=s(window.localStorage),S=s(window.sessionStorage);export default{local:g,ram:d,session:S};
...
`,mimeType:"text/javascript"},"/models/schema.js":{content:`export const version=6;import{slugHooks as i}from"/$app/model/slug.js";import e from"/$app/types/index.js";import g from"/$app/cms/types.js";import o from"/$app.js";import{cmsModels as h}from"/$app/cms/schema.js";e.registerExtension(g);const d=()=>{const m=String(Date.now()+Math.floor(Math.random()*100)),p=Math.floor(Math.random()*100).toString().padStart(2,"0");return Number(m+p)},r=d,a=d;o.models.set({...h,users:{id:e.string({required:!0}),name:e.string({required:!0}),username:e.string(),bio:e.string(),avatar:e.string(),stats:e.object(),email:e.string({required:!0}),password:e.string(),passwordConfirm:e.string(),isGuest:e.boolean({defaultValue:!1}),travelStatus:e.string({defaultValue:"visitor"}),arrivalDate:e.string(),departureDate:e.string(),vibeTime:e.string({defaultValue:"night"}),vibeSocial:e.string({defaultValue:"social"}),vibeDrink:e.string({defaultValue:"caipirinha"}),lookingFor:e.array({defaultValue:[]}),lastKnownLat:e.number(),lastKnownLng:e.number(),likedPlaces:e.belongs_many("places"),likedEvents:e.belongs_many("events"),likedMeetups:e.belongs_many("meetups"),likedGroups:e.belongs_many("groups"),interestedEvents:e.belongs_many("events"),interestedMeetups:e.belongs_many("meetups"),skippedPlaces:e.belongs_many("places"),skippedEvents:e.belongs_many("events"),skippedMeetups:e.belongs_many("meetups"),skippedGroups:e.belongs_many("groups"),createdAt:e.string({})},places:{$hooks:i("name","slug"),id:e.string({required:!0}),name:e.string({required:!0}),slug:e.string({index:!0,immutable:!0}),description:e.string({required:!0}),category:e.string({required:!0,index:!0}),image:e.string({required:!0}),address:e.string(),lat:e.number({index:!0}),lng:e.number({index:!0}),phone:e.string(),website:e.string(),rating:e.number(),reviewCount:e.number({defaultValue:0}),gmapsId:e.string({index:!0}),gmaps:e.object({attribute:!1}),whatsappLink:e.string(),featured:e.boolean({defaultValue:!1,index:!0}),tags:e.array({defaultValue:[],index:!0}),recommended:e.boolean({defaultValue:!1,index:!0}),viewCount:e.number({defaultValue:0}),createdAt:e.string({required:!0,index:!0}),order:e.number({index:!0})},events:{$hooks:i("name","slug"),id:e.string({required:!0}),name:e.string({required:!0}),slug:e.string({index:!0,immutable:!0}),description:e.string({required:!0}),category:e.string({required:!0,index:!0}),image:e.string({required:!0}),date:e.string({index:!0}),time:e.string(),venue:e.string(),price:e.number({defaultValue:0}),currency:e.string({defaultValue:"BRL"}),ticketLink:e.string(),lat:e.number({index:!0}),lng:e.number({index:!0}),place:e.belongs("places"),isRecurring:e.boolean({defaultValue:!1,index:!0}),recurrencePattern:e.string(),recurrenceDays:e.array({defaultValue:[]}),recurrenceEndDate:e.string(),recurrenceParentId:e.string({index:!0}),attendees:e.array({defaultValue:[]}),createdBy:e.belongs("users"),maxAttendees:e.number({defaultValue:20}),isActive:e.boolean({defaultValue:!0,index:!0}),whatsappLink:e.string(),tags:e.array({defaultValue:[],index:!0}),recommended:e.boolean({defaultValue:!1,index:!0}),viewCount:e.number({defaultValue:0}),createdAt:e.string({required:!0,index:!0}),order:e.number({index:!0})},meetups:{$hooks:i("name","slug"),id:e.string({required:!0}),name:e.string({required:!0}),slug:e.string({index:!0,immutable:!0}),description:e.string({required:!0}),category:e.string({required:!0,index:!0}),image:e.string({required:!0}),date:e.string({index:!0}),time:e.string(),venue:e.string(),event:e.belongs("events"),place:e.belongs("places"),lat:e.number({index:!0}),lng:e.number({index:!0}),attendees:e.array({defaultValue:[]}),createdBy:e.belongs("users"),maxAttendees:e.number({defaultValue:20}),isActive:e.boolean({defaultValue:!0,index:!0}),createdAt:e.string({required:!0,index:!0}),order:e.number({index:!0})},groups:{$hooks:i("name","slug"),id:e.string({required:!0}),name:e.string({required:!0}),slug:e.string({index:!0,immutable:!0}),description:e.string({required:!0}),category:e.string({required:!0,index:!0}),image:e.string({required:!0}),groupName:e.string(),memberCount:e.string(),whatsappLink:e.string(),featured:e.boolean({defaultValue:!1,index:!0}),tags:e.array({defaultValue:[],index:!0}),recommended:e.boolean({defaultValue:!1,index:!0}),viewCount:e.number({defaultValue:0}),lat:e.number({index:!0}),lng:e.number({index:!0}),createdAt:e.string({required:!0,index:!0}),order:e.number({index:!0})},guides:{$cms:!0,$hooks:i("title","slug"),id:e.string({required:!0}),title:e.string({required:!0}),slug:e.string({index:!0,immutable:!0}),description:e.string({required:!0}),coverImage:e.media(),guideType:e.string({required:!0,enum:["article","list"],index:!0}),categories:e.array({defaultValue:[]}),body:e.richText(),items:e.array({defaultValue:[]}),author:e.belongs("users"),featured:e.boolean({defaultValue:!1,index:!0}),tags:e.array({defaultValue:[],index:!0}),recommended:e.boolean({defaultValue:!1,index:!0}),viewCount:e.number({defaultValue:0}),status:e.publishStatus(),publishedAt:e.string({index:!0}),scheduledAt:e.string({index:!0}),seo:e.seo(),createdAt:e.string({required:!0,index:!0}),order:e.number({index:!0})},meetup_attendance:{id:e.string({required:!0}),user:e.belongs("users",{required:!0}),meetup:e.belongs("meetups",{required:!0}),status:e.string({defaultValue:"attending",enum:["attending","maybe","cancelled"]}),joinedAt:e.string({required:!0,index:!0}),updatedAt:e.string({index:!0}),createdAt:e.string({required:!0})}});const t=[{id:"guest",name:"Guest",email:"guest@localhost",isGuest:!0},{id:r(),name:"John Brooklyn",username:"@johnbrooklyn",bio:"Travel writers who wrote my own story. Living my life in my style.",email:"john.brooklyn@example.com",stats:{interested:1359,saved:876,attending:28},travelStatus:"visitor",arrivalDate:"2025-12-01",departureDate:"2025-12-15",vibeTime:"morning",vibeSocial:"social",vibeDrink:"coconut",lookingFor:["dates","activities"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Maria Silva",username:"@mariasilva",bio:"Rio local, samba lover, and night owl. Let's dance! \\u{1F483}",email:"maria.silva@example.com",stats:{interested:234,saved:156,attending:42},travelStatus:"resident",vibeTime:"night",vibeSocial:"social",vibeDrink:"caipirinha",lookingFor:["friends","parties"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Carlos Mendez",username:"@carlosnomad",bio:"Digital nomad exploring South America. Always down for a beach day!",email:"carlos.mendez@example.com",stats:{interested:567,saved:345,attending:38},travelStatus:"nomad",arrivalDate:"2025-12-01",departureDate:"2026-02-28",vibeTime:"morning",vibeSocial:"chill",vibeDrink:"coconut",lookingFor:["friends","tips","activities"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Ana Costa",username:"@anacosta",bio:"Party girl visiting from S\\xE3o Paulo. Show me Rio's nightlife! \\u{1F389}",email:"ana.costa@example.com",stats:{interested:892,saved:234,attending:18},travelStatus:"visitor",arrivalDate:"2025-12-10",departureDate:"2025-12-20",vibeTime:"night",vibeSocial:"social",vibeDrink:"beer",lookingFor:["parties","dates"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Lucas Santos",username:"@lucassantos",bio:"Carioca born and raised. Morning runs and a\\xE7a\\xED bowls are my thing.",email:"lucas.santos@example.com",stats:{interested:445,saved:289,attending:31},travelStatus:"resident",vibeTime:"morning",vibeSocial:"chill",vibeDrink:"coconut",lookingFor:["activities","tips"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Julia Martinez",username:"@juliatraveler",bio:"Solo traveler making friends around the world. Let's explore Rio together!",email:"julia.martinez@example.com",stats:{interested:1123,saved:678,attending:45},travelStatus:"visitor",arrivalDate:"2025-12-05",departureDate:"2025-12-25",vibeTime:"night",vibeSocial:"social",vibeDrink:"caipirinha",lookingFor:["friends","parties","dates"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Pedro Oliveira",username:"@pedrolocal",bio:"Beach volleyball enthusiast and Rio tour guide. Ask me anything!",email:"pedro.oliveira@example.com",stats:{interested:356,saved:234,attending:52},travelStatus:"resident",vibeTime:"morning",vibeSocial:"social",vibeDrink:"beer",lookingFor:["friends","activities"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Sofia Rodriguez",username:"@sofiaexplorer",bio:"Remote worker and adventure seeker. Yoga, hiking, and good coffee \\u2615",email:"sofia.rodriguez@example.com",stats:{interested:789,saved:445,attending:35},travelStatus:"nomad",arrivalDate:"2025-11-15",departureDate:"2026-01-31",vibeTime:"morning",vibeSocial:"chill",vibeDrink:"coconut",lookingFor:["tips","activities","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Diego Fernandez",username:"@diegofernandez",bio:"Here for the holidays! Looking to party and meet cool people \\u{1F37B}",email:"diego.fernandez@example.com",stats:{interested:445,saved:167,attending:12},travelStatus:"visitor",arrivalDate:"2025-12-15",departureDate:"2025-12-30",vibeTime:"night",vibeSocial:"social",vibeDrink:"beer",lookingFor:["parties","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Beatriz Lima",username:"@beatrizcarioca",bio:"Rio de Janeiro \\xE9 meu amor! Coffee addict and culture enthusiast \\u{1F3AD}",email:"beatriz.lima@example.com",stats:{interested:612,saved:389,attending:37},travelStatus:"resident",vibeTime:"night",vibeSocial:"social",vibeDrink:"caipirinha",lookingFor:["friends","dates"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Rafael Almeida",username:"@rafaelrio",bio:"Surf instructor and beach lover. Catch me at Prainha! \\u{1F3C4}\\u200D\\u2642\\uFE0F",email:"rafael.almeida@example.com",stats:{interested:234,saved:145,attending:22},travelStatus:"resident",vibeTime:"morning",vibeSocial:"chill",vibeDrink:"coconut",lookingFor:["activities","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Emma Thompson",username:"@emmaexplores",bio:"British expat living in Rio for 2 years. Love samba and a\\xE7a\\xED!",email:"emma.thompson@example.com",stats:{interested:567,saved:345,attending:41},travelStatus:"resident",vibeTime:"night",vibeSocial:"social",vibeDrink:"caipirinha",lookingFor:["parties","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Gabriel Souza",username:"@gabrielcarioca",bio:"DJ and music producer. Ask me about Rio's underground scene \\u{1F3A7}",email:"gabriel.souza@example.com",stats:{interested:892,saved:567,attending:63},travelStatus:"resident",vibeTime:"night",vibeSocial:"social",vibeDrink:"beer",lookingFor:["parties","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Isabella Chen",username:"@isabellawanderer",bio:"Travel blogger from Singapore. Documenting my South America journey!",email:"isabella.chen@example.com",stats:{interested:1456,saved:892,attending:28},travelStatus:"visitor",arrivalDate:"2025-12-01",departureDate:"2025-12-20",vibeTime:"morning",vibeSocial:"social",vibeDrink:"coconut",lookingFor:["tips","activities","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"},{id:r(),name:"Thiago Barbosa",username:"@thiagofitness",bio:"Personal trainer and CrossFit enthusiast. Training on the beach daily!",email:"thiago.barbosa@example.com",stats:{interested:345,saved:189,attending:34},travelStatus:"resident",vibeTime:"morning",vibeSocial:"chill",vibeDrink:"coconut",lookingFor:["activities","friends"],createdAt:new Date().toISOString(),password:"123456890",passwordConfirm:"123456890"}],u=a(),s=a(),l=a(),c=a(),n=a(),b=a();o.data.set({places:[{id:a(),name:"Copacabana Beach",description:"Iconic 4km beach with the famous wave-pattern boardwalk. Perfect for sunbathing, swimming, and people-watching.",category:"beaches",image:"https://picsum.photos/seed/copacabana/400/600",address:"Av. Atl\\xE2ntica, Copacabana, Rio de Janeiro",lat:-22.9711,lng:-43.1822,tags:["family-friendly","must-see","chill"],recommended:!0,viewCount:500,createdAt:"2025-01-01T00:00:00Z",order:4},{id:a(),name:"Ipanema Beach",description:"Trendy beach known for its stunning sunsets, upscale neighborhood, and the famous 'Girl from Ipanema' song.",category:"beaches",image:"https://picsum.photos/seed/ipanema/400/600",address:"Av. Vieira Souto, Ipanema, Rio de Janeiro",lat:-22.9838,lng:-43.2044,whatsappLink:"https://wa.me/?text=Ipanema%20Beach%20is%20amazing!%20\\u{1F305}",tags:["romantic","must-see","local-favorite"],recommended:!0,viewCount:450,createdAt:"2025-01-02T00:00:00Z",order:2},{id:a(),name:"Prainha",description:"Hidden gem beach surrounded by lush green mountains. Less crowded, perfect for surfing and nature lovers.",category:"beaches",image:"https://picsum.photos/seed/prainha/400/600",address:"Av. Estado da Guanabara, Recreio dos Bandeirantes",lat:-23.0425,lng:-43.5008,whatsappLink:"https://wa.me/?text=Found%20this%20hidden%20beach%20gem%20-%20Prainha!%20\\u{1F3C4}",tags:["adventure","chill","local-favorite"],viewCount:120,createdAt:"2025-01-03T00:00:00Z",order:3},{id:a(),name:"Lapa Arches Street Party",description:"Historic neighborhood known for samba, live music, and vibrant nightlife under the famous arches.",category:"parties",image:"https://picsum.photos/seed/lapa/400/600",address:"Arcos da Lapa, Centro, Rio de Janeiro",lat:-22.913,lng:-43.1802,whatsappLink:"https://wa.me/?text=Let's%20party%20at%20Lapa%20Arches!%20\\u{1F389}",tags:["party","local-favorite","must-see"],recommended:!0,viewCount:380,createdAt:"2025-01-04T00:00:00Z",order:4},{id:a(),name:"Confeiteiro Colombo",description:"Historic Belle \\xC9poque caf\\xE9 serving traditional Brazilian pastries and coffee since 1894. A must-visit!",category:"food",image:"https://picsum.photos/seed/colombo/400/600",address:"Rua Gon\\xE7alves Dias, 32, Centro",lat:-22.9067,lng:-43.1773,whatsappLink:"https://wa.me/?text=Amazing%20historic%20caf\\xE9%20-%20Confeitaria%20Colombo!%20\\u2615",tags:["must-see","romantic","local-favorite"],recommended:!0,viewCount:290,createdAt:"2025-01-07T00:00:00Z",order:7},{id:a(),name:"Churrascaria Palace",description:"Traditional Brazilian steakhouse with unlimited rod\\xEDzio service. Experience the best cuts of meat!",category:"food",image:"https://picsum.photos/seed/churrasco/400/600",address:"Rua Rodolfo Dantas, 16, Copacabana",lat:-22.9688,lng:-43.1862,whatsappLink:"https://wa.me/?text=Best%20churrascaria%20in%20Rio!%20\\u{1F969}",tags:["family-friendly","local-favorite"],viewCount:85,createdAt:"2025-01-08T00:00:00Z",order:8},{id:s,name:"Christ the Redeemer",description:"Iconic 98-foot Art Deco statue atop Corcovado Mountain. One of the New Seven Wonders of the World!",category:"culture",image:"https://picsum.photos/seed/christ/400/600",address:"Parque Nacional da Tijuca, Alto da Boa Vista",lat:-22.9519,lng:-43.2105,whatsappLink:"https://wa.me/?text=Visiting%20Christ%20the%20Redeemer!%20\\u271D\\uFE0F",tags:["must-see","family-friendly","wheelchair-accessible"],recommended:!0,viewCount:850,createdAt:"2025-01-10T00:00:00Z",order:10},{id:l,name:"Sugarloaf Mountain Cable Car",description:"Take the cable car to the top for breathtaking 360\\xB0 views of Rio, beaches, and Guanabara Bay.",category:"culture",image:"https://picsum.photos/seed/sugarloaf/400/600",address:"Av. Pasteur, 520, Urca",lat:-22.9489,lng:-43.1575,whatsappLink:"https://wa.me/?text=Amazing%20views%20from%20Sugarloaf%20Mountain!%20\\u{1F6A1}",tags:["must-see","romantic","adventure"],recommended:!0,viewCount:720,createdAt:"2025-01-11T00:00:00Z",order:11},{id:c,name:"Escadaria Selar\\xF3n",description:"Colorful mosaic staircase with 215 steps, decorated with tiles from over 60 countries. Perfect for photos!",category:"culture",image:"https://picsum.photos/seed/selaron/400/600",address:"Rua Joaquim Silva, Lapa",lat:-22.915,lng:-43.1796,whatsappLink:"https://wa.me/?text=Check%20out%20these%20colorful%20steps!%20\\u{1F3A8}",tags:["must-see","free-entry","local-favorite"],viewCount:210,createdAt:"2025-01-12T00:00:00Z",order:12},{id:n,name:"Rio Botanical Garden",description:"Peaceful 340-acre garden with over 6,500 species. Home to giant water lilies and the famous palm tree avenue.",category:"culture",image:"https://picsum.photos/seed/botanical/400/600",address:"Rua Jardim Bot\\xE2nico, 1008, Jardim Bot\\xE2nico",lat:-22.9668,lng:-43.2246,whatsappLink:"https://wa.me/?text=Beautiful%20Botanical%20Garden%20in%20Rio!%20\\u{1F334}",tags:["family-friendly","chill","wheelchair-accessible"],viewCount:180,createdAt:"2025-01-14T00:00:00Z",order:14},{id:b,name:"Arpoador Rock Sunset",description:"Famous spot where locals gather to watch the sunset between Ipanema and Copacabana. Bring your camera!",category:"beaches",image:"https://picsum.photos/seed/arpoador/400/600",address:"Arpoador, between Ipanema and Copacabana",lat:-22.9897,lng:-43.1898,whatsappLink:"https://wa.me/?text=Best%20sunset%20spot%20in%20Rio!%20\\u{1F307}",tags:["romantic","free-entry","local-favorite"],recommended:!0,viewCount:340,createdAt:"2025-01-15T00:00:00Z",order:15}],events:[{id:u,name:"Copacabana Palace Carnival Ball",description:"Exclusive black-tie carnival ball at the iconic Copacabana Palace Hotel. Experience glamour and tradition! Dress code is strictly black tie or luxury costume.",category:"parties",image:"https://picsum.photos/seed/carnival/400/600",date:"2025-03-01",time:"22:00",venue:"Copacabana Palace Hotel",price:2500,currency:"BRL",ticketLink:"https://example.com/tickets",lat:-22.9667,lng:-43.1756,tags:["party","must-see","romantic"],recommended:!0,viewCount:320,createdAt:"2025-01-05T00:00:00Z",order:1},{id:a(),name:"Pedra do Sal Samba Night",description:"Authentic outdoor samba gathering every Monday and Friday. Free event with locals dancing in the streets!",category:"dancing",image:"https://picsum.photos/seed/samba/400/600",date:"2025-12-05",time:"19:00",venue:"Pedra do Sal, Sa\\xFAde",lat:-22.8955,lng:-43.1896,isRecurring:!0,recurrencePattern:"custom",recurrenceDays:[1,5],recurrenceEndDate:"2026-03-31",attendees:[],whatsappLink:"https://wa.me/?text=Join%20me%20for%20samba%20at%20Pedra%20do%20Sal!%20\\u{1F483}",tags:["local-favorite","free-entry","party"],recommended:!0,viewCount:280,createdAt:"2025-01-06T00:00:00Z",order:6},{id:a(),name:"Rio Food Truck Festival",description:"Monthly food festival with 30+ gourmet food trucks, live music, and craft beer. Variety for everyone!",category:"food",image:"https://picsum.photos/seed/foodtruck/400/600",date:"2025-12-15",time:"12:00",venue:"Parque dos Atletas, Barra da Tijuca",lat:-22.9844,lng:-43.3958,attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Food%20Truck%20Festival%20this%20weekend!%20\\u{1F354}",tags:["family-friendly","pet-friendly"],viewCount:95,createdAt:"2025-01-09T00:00:00Z",order:9},{id:a(),name:"Maracan\\xE3 Stadium Tour",description:"Guided tour of the legendary football stadium. Walk on the field, visit locker rooms, and feel the history!",category:"sports",image:"https://picsum.photos/seed/maracana/400/600",date:"2025-12-10",time:"14:00",venue:"Est\\xE1dio do Maracan\\xE3, Maracan\\xE3",lat:-22.9121,lng:-43.2302,attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Stadium%20tour%20at%20Maracan\\xE3!%20\\u26BD",tags:["must-see","wheelchair-accessible","family-friendly"],viewCount:150,createdAt:"2025-01-13T00:00:00Z",order:13},{id:a(),name:"Copacabana Beach Volleyball",description:"Weekly pickup volleyball games at Copacabana Beach. All skill levels welcome! Bring water and sunscreen.",category:"sports",image:"https://picsum.photos/seed/beachvolley/400/600",date:"2025-12-07",time:"09:00",venue:"Posto 6, Copacabana Beach",lat:-22.9711,lng:-43.1822,isRecurring:!0,recurrencePattern:"custom",recurrenceDays:[0,6],recurrenceEndDate:"2026-02-28",attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Beach%20Volleyball%20this%20weekend!%20\\u{1F3D0}",tags:["free-entry","chill","local-favorite"],viewCount:75,createdAt:"2025-01-19T00:00:00Z",order:16},{id:a(),name:"Ipanema Sunset Yoga",description:"Free outdoor yoga sessions at sunset. Bring your own mat and enjoy the ocean breeze. Beginner-friendly!",category:"sports",image:"https://picsum.photos/seed/yoga/400/600",date:"2025-12-05",time:"17:30",venue:"Arpoador Beach",lat:-22.9897,lng:-43.1898,isRecurring:!0,recurrencePattern:"custom",recurrenceDays:[2,4],recurrenceEndDate:"2026-03-31",attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Sunset%20Yoga%20at%20Arpoador!%20\\u{1F9D8}",tags:["free-entry","chill","romantic"],viewCount:110,createdAt:"2025-01-20T00:00:00Z",order:17},{id:a(),name:"Downtown Food Market",description:"Weekly food market featuring local vendors, fresh produce, and street food. Support local businesses!",category:"food",image:"https://picsum.photos/seed/market/400/600",date:"2025-12-05",time:"12:00",venue:"Pra\\xE7a XV, Centro",lat:-22.9035,lng:-43.1758,isRecurring:!0,recurrencePattern:"custom",recurrenceDays:[4],recurrenceEndDate:"2025-12-31",attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Food%20Market%20on%20Thursday!%20\\u{1F34E}",tags:["free-entry","family-friendly","local-favorite"],viewCount:88,createdAt:"2025-01-21T00:00:00Z",order:18},{id:a(),name:"Lapa Street Party",description:"The legendary Lapa nightlife experience! Samba, caipirinhas, and live music under the arches every weekend.",category:"parties",image:"https://picsum.photos/seed/lapaparty/400/600",date:"2025-12-05",time:"22:00",venue:"Arcos da Lapa, Centro",lat:-22.913,lng:-43.1802,isRecurring:!0,recurrencePattern:"custom",recurrenceDays:[5,6],recurrenceEndDate:"2026-03-01",attendees:[t[0].id,t[1].id,t[2].id,t[3].id,t[4].id,t[5].id],whatsappLink:"https://wa.me/?text=Party%20at%20Lapa%20tonight!%20\\u{1F389}",tags:["party","local-favorite","must-see"],recommended:!0,viewCount:260,createdAt:"2025-01-22T00:00:00Z",order:19}],meetups:[{id:a(),name:"Pre-Ball Drinks",description:"Let's meet for some champagne before heading into the Palace! Meeting at the hotel bar.",category:"parties",image:"https://picsum.photos/seed/drinks/400/300",date:"2025-03-01",time:"20:00",venue:"Pergula Restaurant",event:u,attendees:[],createdAt:"2025-01-25T00:00:00Z",order:3}],groups:[{id:a(),name:"MEETUP.RIO - Official",description:"The main MEETUP.RIO community! Connect with travelers, get insider tips, and join events happening around Rio.",category:"groups",groupName:"MEETUP.RIO - Official",memberCount:"1,200+ members",image:"https://picsum.photos/seed/meetuprio/400/600",lat:-22.9068,lng:-43.1729,whatsappLink:"https://chat.whatsapp.com/MEETUPRIO",featured:!0,tags:["local-favorite","must-see"],recommended:!0,viewCount:450,createdAt:"2025-01-01T00:00:00Z",order:20},{id:a(),name:"Rio Events & Parties",description:"Stay updated on the hottest parties, festivals, and events in Rio. Organized by MEETUP.RIO team.",category:"groups",groupName:"Rio Events & Parties",memberCount:"800+ members",image:"https://picsum.photos/seed/rioevents/400/600",lat:-22.9068,lng:-43.1729,whatsappLink:"https://chat.whatsapp.com/RIOEVENTS",featured:!0,tags:["party","local-favorite"],viewCount:320,createdAt:"2025-01-02T00:00:00Z",order:21},{id:a(),name:"Ipanema Locals",description:"Community group for people living in or visiting Ipanema. Share tips, meetups, and local recommendations.",category:"groups",groupName:"Ipanema Locals",memberCount:"350+ members",image:"https://picsum.photos/seed/ipanema-group/400/600",lat:-22.9838,lng:-43.2044,whatsappLink:"https://chat.whatsapp.com/IPANEMA",featured:!1,tags:["chill","local-favorite"],viewCount:85,createdAt:"2025-01-16T00:00:00Z",order:22},{id:a(),name:"Rio Food Lovers",description:"For food enthusiasts! Share restaurant recommendations, food truck finds, and organize dinner meetups.",category:"groups",groupName:"Rio Food Lovers",memberCount:"500+ members",image:"https://picsum.photos/seed/foodies/400/600",lat:-22.9068,lng:-43.1729,whatsappLink:"https://chat.whatsapp.com/RIOFOODIES",featured:!1,tags:["local-favorite","family-friendly"],viewCount:120,createdAt:"2025-01-17T00:00:00Z",order:23},{id:a(),name:"Beach Volleyball Rio",description:"Join pickup games at Copacabana and Ipanema! All skill levels welcome. Games usually weekends.",category:"groups",groupName:"Beach Volleyball Rio",memberCount:"280+ members",image:"https://picsum.photos/seed/volleyball/400/600",lat:-22.9711,lng:-43.1822,whatsappLink:"https://chat.whatsapp.com/VOLLEYBALL",featured:!1,tags:["chill","free-entry"],viewCount:65,createdAt:"2025-01-18T00:00:00Z",order:24}],guides:[{id:a(),title:"Complete Guide to Rio's Best Beaches",description:"From the iconic Copacabana to hidden gems like Prainha - everything you need to know about Rio's stunning coastline.",coverImage:"https://picsum.photos/seed/beaches-guide/400/600",guideType:"article",categories:["beaches"],tags:["must-see","family-friendly","chill"],recommended:!0,body:\`Rio de Janeiro is blessed with some of the world's most beautiful beaches, each with its own unique character and vibe.
...
- The party goes until 4-5am!\`,status:"published",featured:!1,publishedAt:"2025-01-19T00:00:00Z",createdAt:"2025-01-19T00:00:00Z",order:5}],users:t});
...
`,mimeType:"text/javascript"},"/$app/types/index.js":{content:'import j from"./timestamp.js";const E={email:/^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/},q=e=>{try{return e in b?e:JSON.parse(e)}catch{return}},b={undefined:void 0,null:null,"":null,[void 0]:void 0},d={any:e=>e,function:e=>e,boolean:(e,{attribute:n=!0}={})=>n&&e===""||["true",1,"1",!0].includes(e),string:e=>e in b?b[e]:String(e),array:(e,n={})=>{if(Array.isArray(e))return e;const{itemType:t}=n;try{if(!e)throw e;const r=q(e);if(!Array.isArray(r))throw r;return t?r.map(u=>typeof u!="object"?u:Object.entries(u).reduce((s,[i,a])=>(s[i]=d[t[i]?.type]?d[t[i].type](a,n):a,s),{})):r}catch{return[]}},number:e=>e==null||e===""?e:Number(e),date:e=>e?e instanceof Date?e:new Date(e):null,datetime:e=>e?e instanceof Date?e:new Date(e):null,object:(e,n={})=>{if(e===null)return null;const t=typeof e=="string"?q(e):e;return n.properties&&t&&typeof t=="object"&&Object.entries(n.properties).map(([r,u])=>{u.defaultValue!==void 0&&t[r]===void 0&&(t[r]=u.defaultValue)}),t}},H=(e,n={})=>{const{type:t}=n;return(d[t]||(r=>r))(e,n)},$={datetime:(e,n={})=>{if(e===null)return n.required?["required",null]:null;if(!(e instanceof Date)||Number.isNaN(e.getTime()))return["invalid","invalid datetime"];if(n.min&&e<new Date(n.min))return["minimum",null];if(n.max&&e>new Date(n.max))return["maximum",null]},date:(e,n={})=>{if(e===null)return n.required?["required",null]:null;if(!(e instanceof Date)||Number.isNaN(e.getTime()))return["invalid","invalid date"];if(n.min&&e<new Date(n.min))return["minimum",null];if(n.max&&e>new Date(n.max))return["maximum",null]},object:(e,n={})=>{if(e===null)return n.required?["required",null]:["invalid","null is not an object"];if(typeof e!="object"||Array.isArray(e))return["invalid","not an object"]},number:(e,n={})=>{if(Number.isNaN(Number(e)))return!n.required&&(e==null||e==="")?null:["NaN",null];if("min"in n&&e<n.min)return["minimum",null];if("max"in n&&e>n.max)return["maximum",null]}},g=(e,n,t={})=>{if(e===void 0&&n.defaultValue!==void 0&&(e=n.defaultValue),n.required===!0&&(e==null||e===""))return["required",null];if(n.customValidator){const i=n.customValidator(e,n,t);if(i)return i}if(n.relationship)return n.many?[null,Array.isArray(e)?e.map(i=>n.mixed?i:i?.id??i):[]]:[null,e?.id??e];const r=d[n.type];let u=r?r(e,n):e;if((e==null||e==="")&&n.defaultValue!==void 0&&(u=n.defaultValue),n.required===!0&&(u==null||u===""))return["required",null];if(!n.required&&u==null&&!(n.type==="object"&&u===null))return[null,u];const s=$[n.type];if(s){const i=s(u,n);if(i)return i}if(n.format){const i=E[n.format]||(typeof n.format=="function"?n.format:null);if(i&&!(typeof i=="function"?i:y=>i.test(y))(u))return["invalid",`invalid format: ${n.format}`]}return[null,u]},A={validate(e,n={}){const[t,r]=g(e,this,n);return t?{valid:!1,error:t,details:r,value:e}:{valid:!0,value:r,error:null,details:null}}};function D(e,n){return e.replace(/\\${(.*?)}/g,(t,r)=>n[r.trim()])}const C=(e,{schema:n,row:t={},undefinedProps:r=!0,validateVirtual:u=!1,operation:s=null})=>{if(!n)return[null,e];const i={};let a=!1;const m={operation:s,row:t},y=r?n:e;for(const l in y){const f={...n[l],key:l};if("virtual"in f||f.persist===!1)continue;const c=f.customValidator||e[l]!==void 0||f.required,[V,N]=c?g(e[l],f,m):[null,f.defaultValue];V?(a=!0,i[l]=V):N!==void 0&&(e[l]=N)}const o=Object.fromEntries(Object.entries(n).filter(([l,f])=>"virtual"in f));for(const l in o)if(u){const[f,c]=g(D(o[l].virtual,{...t,...e}),o[l],m);f?(a=!0,i[l]=f):c!==void 0&&(e[l]=c)}else e[l]=D(o[l].virtual,{...t,...e});return a?[i,null]:[null,e]},O=(e,n)=>{const t=typeof n=="object"&&!Array.isArray(n)&&n!==null?n:{defaultValue:n},r={type:e,persist:!0,attribute:!["array","object","function"].includes(e),...t};return Object.setPrototypeOf(r,A),r},T={createType:O,parse:H,validateType:C},x={},F=e=>{e.types&&Object.assign(x,e.types)};T.registerExtension=F;const P=e=>(...n)=>{const t=n[0];let r,u=n[2];typeof n[1]=="string"?r=n[1]:u=n[1];const s=w.includes(e),i={type:s?e==="belongs_many"?"array":"string":e==="one"?"string":"array",many:h.includes(e),belongs:s,persist:s,relationship:e,defaultValue:e==="belongs_many"?[]:null,polymorphic:t==="*"||Array.isArray(t),targetModel:t,targetForeignKey:r,index:w.includes(e),...u};return Object.setPrototypeOf(i,A),i},S=["one","many","belongs","belongs_many"],h=["many","belongs_many"],w=["belongs","belongs_many"],J={get(e,n){if(e[n])return e[n];if(x[n])return x[n];const t=n.toLowerCase();return S.includes(n)?P(n):(r={})=>{if(!d[t])throw new Error(`Unknown type: ${t}`);return O(t,r)}}},_=new Proxy(T,J);_.registerExtension(j);export default _;\n',mimeType:"text/javascript"},"/$app/cms/schema.js":{content:`import e from"/$app/types/index.js";import u from"/$app.js";export const getCmsModels=()=>Object.entries(u.models).filter(([t,r])=>r.$cms===!0).map(([t])=>t),cmsModels={cms_media:{id:e.string({required:!0}),url:e.string({required:!0}),name:e.string({required:!0}),alt:e.string({defaultValue:""}),size:e.number({defaultValue:0}),type:e.string({defaultValue:"image/jpeg"}),width:e.number(),height:e.number(),folder:e.string({defaultValue:"",index:!0}),tags:e.array({defaultValue:[],index:!0}),createdAt:e.string({required:!0,index:!0}),updatedAt:e.string({index:!0})}},cmsFields={status:e.string({defaultValue:"draft",enum:["draft","published","scheduled"],index:!0}),publishedAt:e.string({index:!0}),scheduledAt:e.string({index:!0}),seo:e.object({attribute:!1,defaultValue:{metaTitle:"",metaDescription:"",ogImage:""}})};export default{cmsModels,cmsFields};
...
`,mimeType:"text/javascript"},"/views/templates/app.js":{content:`import s from"/$app/router/index.js";import o from"/$app/types/index.js";import a from"/$app.js";import{html as n}from"/npm/lit-html";const{brand:l,navTabs:r}=a.settings;export default{class:"min-h-screen w-full bg-purple-50 flex flex-col font-sans",properties:{currentRoute:o.object({sync:s}),currentLang:o.string("en"),modalItem:o.object(null),modalOpen:o.boolean(!1),userId:o.number({sync:"local"})},getActiveTabFromRoute(){const t=this.currentRoute?.name;return r.map(i=>i.id).filter(i=>i!=="discover").includes(t)?t:"discover"},render(){const t=this.getActiveTabFromRoute();return n\`
      <!-- Desktop Top Nav -->
      <nav class="hidden md:flex items-center justify-between px-6 py-4 bg-white border-b-3 border-black">
        ...
        <div class="flex items-center gap-6">
          \${r.map(e=>n\`
              <uix-link
                href=\${e.route}
                class="font-bold uppercase text-sm transition-colors \${t===e.id?l.accentClass:\`text-black hover:\${l.accentClass}\`}"
              >
                \${e.label}
              </uix-link>
            \`)}
...
`,mimeType:"text/javascript"},"/views/logo.js":{content:'import{html as n}from"/npm/lit-html";export default{render(){return n`<uix-link href="/" class="text-2xl font-black uppercase tracking-tight">\n          <uix-icon name="tree-palm" size="lg"></uix-icon>\n          ${$APP.settings.brand.name}<span class="${$APP.settings.brand.accentClass} -ml-1">${$APP.settings.brand.accent}</span>\n        </uix-link>`}};\n',mimeType:"text/javascript"},"/$app/uix/display/link.js":{content:`import r from"/$app/router/index.js";import t from"/$app/types/index.js";import{html as n}from"/npm/lit-html";export default{tag:"uix-link",style:!0,shadow:!0,properties:{content:t.object(),external:t.boolean(),skipRoute:t.boolean(),hideLabel:t.boolean(),disabled:t.boolean(),name:t.string(),alt:t.string(),label:t.string(),type:t.string(),href:t.string(),related:t.string(),icon:t.string(),click:t.function(),confirmation:t.string(),popovertarget:t.string(),popovertargetaction:t.string()},_handlePopoverTarget(e){if(!this.popovertarget)return!1;const i=document.getElementById(this.popovertarget);if(!i||typeof i.toggle!="function")return!1;e.preventDefault(),e.stopPropagation();const a=this.shadowRoot.querySelector("button, a"),o=this.popovertargetaction||"toggle";return o==="toggle"?i.toggle(a):o==="show"?i._open(a):o==="hide"&&i._close(),!0},_defaultOnClick(e){if(this.disabled){e.preventDefault(),e.stopImmediatePropagation();return}this._handlePopoverTarget(e)||this.href&&!this.skipRoute&&r.handleLinkClick(e,{external:this.external})||(this.href||e.preventDefault(),this.click&&this.type!=="submit"&&(this.confirmation?window.confirm(this.confirmation)&&this.click(e):this.click(e),e.stopImmediatePropagation()))},render(){const e=n\`
    ...
    \`}};
`,mimeType:"text/javascript"},"/$app/uix/display/icon.js":{content:'import s from"/$app/types/index.js";import{settings as i}from"/$app/view/index.js";import{unsafeHTML as n}from"/npm/lit-html/directives/unsafe-html.js";const o=new Map;export default{tag:"uix-icon",style:!0,static:{Icons:o},properties:{name:s.string(),svg:s.string(),solid:s.boolean(),size:s.string(),color:s.string({enum:["primary","secondary","success","danger","warning","info","inverse"]})},async getIcon(t){if(o.has(t))this.svg=o.get(t);else try{const e=await fetch(`${i.iconFontFamily}/${t}.svg`);if(e.ok){const r=await e.text();o.set(t,r),this.svg=r}else console.error(`Failed to fetch icon: ${t}`)}catch(e){console.error(`Error fetching icon: ${t}`,e)}},willUpdate({changedProps:t}){t.has("name")&&this.getIcon(this.name)},connected(){this.getIcon(this.name)},render(){return this.svg?n(this.svg):null}};\n',mimeType:"text/javascript"},"/views/discover-view.js":{content:`import r from"/$app/types/index.js";import e from"/$app.js";import{html as s}from"/npm/lit-html";import{NBS as c}from"./utils.js";const{brand:x}=e.settings;export default{style:!0,properties:{userId:r.string({defaultValue:"guest"}),places:r.array({sync:e.Model.places,query:{}}),events:r.array({sync:e.Model.events,query:{}}),groups:r.array({sync:e.Model.groups,query:{}}),guides:r.array({sync:e.Model.guides,query:{}}),searchQuery:r.string({defaultValue:""})},async connected(){this.userId=e.Auth.isAuthenticated?e.Auth.currentUserId:"guest"},isLoading(){return!this.places||!this.events||!this.groups},getNextEvents(){return(this.events||[]).sort((d,a)=>new Date(d.date)-new Date(a.date))},getFeaturedGuides(){return(this.guides||[]).filter(d=>d.featured).slice(0,2)},getRecommendedItems(){const d=(this.places||[]).filter(i=>i.recommended||i.viewCount>=100),a=(this.events||[]).filter(i=>i.recommended||i.viewCount>=100);return[...d,...a].slice(0,4)},render(){if(this.isLoading())return c.SPINNER;const d=this.events??[],a=this.places??[],i=this.getFeaturedGuides(),o=this.getRecommendedItems();return s\`
      <div class="space-y-6 pb-8">
        ...
        <div class="md:px-6 overflow-hidden mx-1 max-w-screen">
          <div class="flex justify-between items-center mb-4">
            ...
            <button @click=\${()=>e.Router.go("events")} class="text-xs font-bold text-pink-700 uppercase hover:underline">View all</button>
          </div>
          <div class="flex gap-4 overflow-x-auto pb-4">
            \${d.length===0?s\`<div class="text-sm font-bold text-gray-500 italic">No upcoming events found.</div>\`:d.map(t=>s\`
                <view-story-circle .content=\${t} .onClick=\${l=>e.Router.go("event-detail",{slug:l.slug})} class="last:mr-1"></view-story-circle>
              \`)}
          </div>
        </div>
          ...
          <div class="px-6 overflow-hidden">
            <div class="flex items-center gap-3 mb-4">
              <span class="px-3 py-1 bg-yellow-300 border-2 border-black rounded-lg font-black text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                \u2B50 \${e.i18n?.t?.("badges.recommended")||"Recommended"}
              </span>
            </div>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pb-4">
              \${o.map(t=>{const l=t.date!==void 0,n=l?"event":"place";return s\`
                  <div
                    ...
                    @click=\${()=>e.Router.go(\`\${n}-detail\`,{slug:t.slug})}
                  >
                    ...
                    <div class="p-2">
                      <div class="text-xs font-black leading-tight line-clamp-2 uppercase">\${t.name}</div>
                      \${l&&t.date?s\`
                        <div class="text-[10px] font-bold text-gray-500 mt-1">\u{1F4C5} \${new Date(t.date).toLocaleDateString()}</div>
                      \`:null}
                    </div>
                  </div>
                \`})}
        ...
        \${i.length>0?s\`
          <div class="px-6 overflow-hidden">
            <div class="flex justify-between items-center mb-4">
              ...
              <button @click=\${()=>e.Router.go("guides")} class="text-xs font-bold text-pink-700 uppercase hover:underline">View all</button>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pb-4">
              \${i.map(t=>s\`
                  <view-guide-card
                    .guide=\${t}
                    .featured=\${!0}
                    .onClick=\${l=>e.Router.go("guide-detail",{slug:l.slug})}
                  ></view-guide-card>
                \`)}
            </div>
          </div>
        ...
        <div class="px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 p-2 md:p-4 lg:p-8">
            \${a.map(t=>s\`
                <view-meetup-card-compact .content=\${t} type="place" .onClick=\${l=>e.Router.go("place-detail",{slug:l.slug})}></view-meetup-card-compact>
              \`)}
          </div>
        </div>
      </div>
...
`,mimeType:"text/javascript"},"/views/meetup-card-compact.js":{content:`import e from"/$app/types/index.js";import{html as o}from"/npm/lit-html";import i from"/$app.js";import{CATEGORIES as d,getCategoryColor as p}from"./utils.js";export default{style:!0,properties:{content:e.object({attribute:!1}),onClick:e.function({attribute:!1}),type:e.string({defaultValue:""}),showTags:e.boolean({defaultValue:!0}),showBadge:e.boolean({defaultValue:!0})},getCategoryEmoji(){return d[this.content?.category]?.icon||"\\u{1F4CD}"},handleCardClick(t){t.target.closest(".join-button")||this.onClick&&this.onClick(this.content)},handleJoinClick(t){t.stopPropagation()},render(){if(!this.content)return null;const{showTags:t,showBadge:s}=this,a=this.content.joined,r=t&&this.content.tags?.length>0,c=s&&(this.content.recommended||this.content.viewCount>=100),l=\`join-button w-full py-2 px-4 border-2 border-black rounded-lg font-black uppercase text-xs transition-all duration-200 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] \${a?"bg-primary text-black hover:bg-primary-dark":"bg-accent text-black hover:bg-accent"}\`;return o\`
    ...
    \`}};
`,mimeType:"text/javascript"},"/$app/icon-lucide/lucide/tree-palm.svg":{content:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M13 8c0-2.76-2.46-5-5.5-5S2 5.24 2 8h2l1-1l1 1h4m3-.86A5.82 5.82 0 0 1 16.5 6c3.04 0 5.5 2.24 5.5 5h-3l-1-1l-1 1h-3"/><path d="M5.89 9.71c-2.15 2.15-2.3 5.47-.35 7.43l4.24-4.25l.7-.7l.71-.71l2.12-2.12c-1.95-1.96-5.27-1.8-7.42.35"/><path d="M11 15.5c.5 2.5-.17 4.5-1 6.5h4c2-5.5-.5-12-1-14"/></g></svg>',mimeType:"image/svg+xml"},"/views/guide-card.js":{content:`import a from"/$app/types/index.js";import n from"/$app.js";import{html as l}from"/npm/lit-html";import{getCategoryColor as p}from"./utils.js";export default{properties:{guide:a.object(),featured:a.boolean({defaultValue:!1}),onClick:a.function({attribute:!1})},handleClick(){this.onClick&&this.onClick(this.guide)},render(){const e=this.guide;if(!e)return null;const s=e.guideType==="article",c=s?"Article":"Curated List",i=s?"bg-amber-300":"bg-emerald-300",r=s?"\\u{1F4DD}":"\\u{1F4CB}",o=e.recommended||e.viewCount>=100,d=e.tags?.length>0;return this.featured?l\`
        <div
        ...
        >
          <div class="relative h-48 bg-gray-200">
            ...
            <div class="absolute top-3 left-3 flex gap-2">
              <span class="px-3 py-1 \${i} border-2 border-black rounded-lg font-black text-xs uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                \${r} \${c}
              </span>
            </div>
            \${o?l\`
          ...
          <div class="p-4 space-y-3">
            ...
            <div class="flex items-center gap-2 flex-wrap">
              \${(e.categories||[]).map(t=>l\`
                <span class="px-2 py-1 \${p(t)} border-2 border-black rounded-lg font-bold text-xs uppercase">
                  \${n.i18n?.t?.(\`categories.\${t}\`)||t}
                </span>
              \`)}
              \${!s&&e.items?.length?l\`
      ...
      >
        <div class="relative h-32 bg-gray-200 flex-shrink-0">
          ...
          <div class="absolute top-2 left-2">
            <span class="px-2 py-0.5 \${i} border-2 border-black rounded font-bold text-[10px] uppercase">
              \${r} \${s?"Article":"List"}
            </span>
          </div>
          \${o?l\`
        ...
        <div class="p-3 flex-1 flex flex-col">
          ...
          <div class="flex items-center gap-1 mt-2 flex-wrap">
            \${(e.categories||[]).slice(0,2).map(t=>l\`
              <span class="px-1.5 py-0.5 \${p(t)} border border-black rounded font-bold text-[9px] uppercase">
                \${n.i18n?.t?.(\`categories.\${t}\`)||t}
              </span>
            \`)}
            \${!s&&e.items?.length?l\`
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 space-y-6">
              <view-detail-info-card
                ...
                \`}
                .afterDescription=\${e.ticketLink?()=>i\`
                      <div class="mt-6 pt-6 border-t-2 border-dashed border-gray-300">
                      ...
                      <div class="space-y-4">
                        \${s.map(r=>i\`
                            <div
                              ...
                              @click=\${()=>t.Router.go("meetup-detail",{slug:r.slug})}
                            >
                              <div
...
`,mimeType:"text/css"},"/views/profile-view.js":{content:'import n from"/$app/types/index.js";import i from"/$app.js";import{html as r}from"/npm/lit-html";import{NBS as o}from"./utils.js";export default{properties:{userId:n.string({defaultValue:"guest"}),currentUser:n.object({sync:i.Model.users,query:e=>({id:e.userId,includes:["likedPlaces","likedEvents","likedMeetups","likedGroups","interestedEvents","interestedMeetups"]}),dependsOn:["userId"]}),meetupAttendance:n.array({defaultValue:[]}),activeTab:n.string({defaultValue:"attending"}),showOnboarding:n.boolean({defaultValue:!1})},async connected(){this.userId=i.Auth.isAuthenticated?i.Auth.currentUserId:"guest",this.meetupAttendance=await i.Model.meetup_attendance.getAll({where:{user:this.userId}})},getStats(){if(!this.currentUser)return{eventsJoined:0,saved:0,attending:0};const e=this.currentUser,d=new Set((this.meetupAttendance||[]).map(t=>t.meetup));return{attending:(e.likedMeetups||[]).filter(t=>d.has(t.id)).length,saved:(e.likedPlaces?.length||0)+(e.likedEvents?.length||0)+(e.likedMeetups?.length||0)+(e.likedGroups?.length||0),eventsJoined:e.interestedEvents?.length||0}},async handleSaveProfile(e){const d=i.Auth.user;d&&await i.Model.users.edit({id:d.id,...e}),this.showOnboarding=!1},getTabContent(){if(!this.currentUser)return[];const e=this.currentUser,d=new Set((this.meetupAttendance||[]).map(t=>t.meetup));switch(this.activeTab){case"attending":return(e.likedMeetups||[]).filter(t=>d.has(t.id)).map(t=>({...t,_type:"meetup"}));case"saved":return[...(e.likedPlaces||[]).map(t=>({...t,_type:"place"})),...(e.likedEvents||[]).map(t=>({...t,_type:"event"})),...(e.likedMeetups||[]).map(t=>({...t,_type:"meetup"})),...(e.likedGroups||[]).map(t=>({...t,_type:"group"}))];case"history":{const t=new Map;return(e.likedPlaces||[]).forEach(s=>t.set(`place-${s.id}`,{...s,_type:"place"})),(e.likedEvents||[]).forEach(s=>t.set(`event-${s.id}`,{...s,_type:"event"})),(e.likedMeetups||[]).forEach(s=>t.set(`meetup-${s.id}`,{...s,_type:"meetup"})),(e.likedGroups||[]).forEach(s=>t.set(`group-${s.id}`,{...s,_type:"group"})),(e.interestedEvents||[]).forEach(s=>t.set(`event-${s.id}`,{...s,_type:"event"})),(e.interestedMeetups||[]).forEach(s=>t.set(`meetup-${s.id}`,{...s,_type:"meetup"})),Array.from(t.values())}default:return[]}},render(){const e=this.currentUser||i.Auth.user||{};if(!e||!this.currentUser)return o.SPINNER;const d=this.getTabContent(),t=this.getStats(),s=e.arrivalDate&&e.departureDate?`${new Date(e.arrivalDate).toLocaleDateString(void 0,{month:"short",day:"numeric"})} - ${new Date(e.departureDate).toLocaleDateString(void 0,{month:"short",day:"numeric"})}`:"",p="absolute top-6 right-6 bg-white p-2 rounded-xl border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all",c=a=>`flex-1 py-3 px-2 border-3 border-black rounded-xl font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all ${o.ACTIVE_SM} ${this.activeTab===a?"bg-accent text-black":"bg-white text-black"}`;return r`\n      <div class="px-4 sm:px-8 mx-auto pb-20">\n        <view-onboarding-wizard\n          .isOpen=${this.showOnboarding} .user=${e}\n          .onClose=${()=>this.showOnboarding=!1} .onSave=${this.handleSaveProfile.bind(this)}\n        ></view-onboarding-wizard>\n        <div class="relative bg-white border-b-3 border-black rounded-b-[2.5rem] p-8 pb-16 shadow-[0px_4px_0px_0px_rgba(0,0,0,1)]">\n          <button @click=${()=>this.showOnboarding=!0} class="${p}">\u270F\uFE0F Edit</button>\n          <div class="flex justify-center mb-4 mt-4">\n            <div class="w-32 h-32 rounded-3xl border-3 border-black bg-cover bg-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-white"\n              style="background-image: url(${e.avatar})"\n            ></div>\n          </div>\n          <div class="text-center space-y-2">\n            <h1 class="text-3xl font-black flex items-center justify-center gap-2 text-black">\n              ${e.name}\n              <div class="bg-blue-400 text-white rounded-full p-1 border-2 border-black w-6 h-6 flex items-center justify-center text-[10px]">\u2713</div>\n            </h1>\n            <div class="flex flex-wrap justify-center gap-2 max-w-xs mx-auto">\n              <div class="px-3 py-1 bg-white border-2 border-black rounded-lg font-bold text-xs shadow-sm flex items-center gap-1">\n                ${e.travelStatus==="resident"?"\\u{1F3E0} Local":"\\u2708\\uFE0F Visitor"}\n              </div>\n              ${s?r`\n                <div class="px-3 py-1 bg-accent border-2 border-black rounded-lg font-bold text-xs shadow-sm flex items-center gap-1">\n                  \u{1F5D3}\uFE0F ${s}\n                </div>\n              `:null}\n            </div>\n            <div class="flex flex-wrap justify-center gap-2 pt-2">\n              ${e.vibeTime?r`<span class="px-2 py-1 bg-secondary-lighter border border-black rounded-md text-[10px] font-bold uppercase">${e.vibeTime}</span>`:null}\n              ${e.vibeDrink?r`<span class="px-2 py-1 bg-secondary-lighter border border-black rounded-md text-[10px] font-bold uppercase">${e.vibeDrink}</span>`:null}\n              ${(e.lookingFor||[]).slice(0,2).map(a=>r`<span class="px-2 py-1 bg-primary-lighter border border-black rounded-md text-[10px] font-bold uppercase">Looking for ${a}</span>`)}\n            </div>\n            ${e.bio?r`<p class="text-center text-sm font-bold text-gray-700 mt-4 max-w-md mx-auto">${e.bio}</p>`:null}\n          </div>\n        </div>\n        <div class="px-4 sm:px-6 -mt-10 relative z-10 mb-8">\n          <div class="grid grid-cols-3 bg-white border-3 border-black rounded-2xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] divide-x-2 divide-black p-2">\n            <div class="text-center py-3"><div class="text-2xl font-black text-black">${t.eventsJoined}</div><div class="text-[10px] font-bold uppercase text-gray-500 mt-1">Events Joined</div></div>\n            <div class="text-center py-3"><div class="text-2xl font-black text-black">${t.saved}</div><div class="text-[10px] font-bold uppercase text-gray-500 mt-1">Saved</div></div>\n            <div class="text-center py-3"><div class="text-2xl font-black text-black">${t.attending}</div><div class="text-[10px] font-bold uppercase text-gray-500 mt-1">Attending</div></div>\n          </div>\n        </div>\n        <div class="flex gap-2 p-4 sm:p-6 mb-2">\n          ${["attending","saved","history"].map(a=>r`<button @click=${()=>this.activeTab=a} class="${c(a)}">\n              ${a==="attending"?"Attending":a==="saved"?"Saved":"History"}\n            </button>`)}\n        </div>\n        <div class="px-4 sm:px-6 mb-12">\n          ${d.length>0?r`<div class="grid grid-cols-2 gap-4">\n              ${d.map(a=>r`<view-meetup-card-compact .content=${a} .onClick=${l=>i.Router.go(`${l._type}-detail`,{slug:l.slug})}></view-meetup-card-compact>`)}\n            </div>`:r`<div class="bg-white border-3 border-black rounded-2xl p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center space-y-4">\n              <div class="text-5xl mb-4">${this.activeTab==="attending"?"\\u{1F4C5}":this.activeTab==="saved"?"\\u{1F4BE}":"\\u{1F4DA}"}</div>\n              <p class="text-lg font-bold text-gray-600">\n                ${this.activeTab==="attending"?"No events joined yet":this.activeTab==="saved"?"No saved places yet":"No activity yet"}\n              </p>\n              <button @click=${()=>i.Router.go("discover")} class="${"mt-4 px-6 py-2 bg-accent border-3 border-black rounded-xl font-black uppercase text-sm shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] transition-all"}">Explore Events</button>\n            </div>`}\n        </div>\n      </div>\n    `}};\n',mimeType:"text/javascript"},"/views/onboarding-wizard.js":{content:`import i from"/$app/types/index.js";import{html as s}from"/npm/lit-html";const n="border-3 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all";export default{properties:{isOpen:i.boolean({defaultValue:!1}),user:i.object({attribute:!1}),onSave:i.function({attribute:!1}),onClose:i.function({attribute:!1}),formData:i.object({defaultValue:{}})},connected(){this.user&&(this.formData={travelStatus:this.user.travelStatus||"visitor",arrivalDate:this.user.arrivalDate||"",departureDate:this.user.departureDate||"",vibeTime:this.user.vibeTime||"morning",vibeSocial:this.user.vibeSocial||"social",vibeDrink:this.user.vibeDrink||"caipirinha",lookingFor:this.user.lookingFor||[]})},updateField(e,a){this.formData={...this.formData,[e]:a}},toggleLookingFor(e){const a=this.formData.lookingFor||[];this.updateField("lookingFor",a.includes(e)?a.filter(l=>l!==e):[...a,e])},handleStepChange(e){e.detail.step===2&&e.detail.direction==="forward"&&this.formData.travelStatus==="resident"&&setTimeout(()=>e.target.nextStep(),0)},handleFinish(){this.onSave&&this.onSave(this.formData)},handleCancel(){this.onClose&&this.onClose()},render(){if(!this.isOpen)return null;const e=t=>\`w-full p-4 border-3 border-black rounded-2xl font-black uppercase text-lg flex items-center justify-between \${n} \${this.formData.travelStatus===t?"bg-accent":"bg-white"}\`,a=(t,r,o)=>\`flex-1 py-3 border-2 border-black rounded-xl font-bold text-sm \${this.formData[r]===t?o:"bg-white"}\`,l=[{id:"friends",label:"New Friends \\u{1F46F}"},{id:"dates",label:"Dates \\u2764\\uFE0F"},{id:"activities",label:"Activity Partners \\u{1F3BE}"},{id:"tips",label:"Local Tips \\u{1F5FA}\\uFE0F"},{id:"party",label:"Parties \\u{1F389}"}];return s\`
          ...
          <div class="space-y-3 mb-8">
            \${l.map(t=>s\`
                <button
                  ...
                  class="w-full py-3 px-4 border-2 border-black rounded-xl font-bold text-left flex justify-between items-center transition-all \${(this.formData.lookingFor||[]).includes(t.id)?"bg-pink-300 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] translate-x-[1px] translate-y-[1px]":"bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"}"
                >
                  <span>\${t.label}</span>
    ...
    \`}};
`,mimeType:"text/javascript"},"/views/groups-view.js":{content:`import a from"/$app/types/index.js";import o from"/$app.js";import{html as s}from"/npm/lit-html";import{ALL_TAGS as c,NBS as g}from"./utils.js";const{brand:h}=o.settings;export default{dataQuery:!0,properties:{groups:a.array(),selectedTags:a.array({defaultValue:[]})},goToGroup(e){o.Router.go("group-detail",{slug:e.slug})},toggleTag(e){this.selectedTags.includes(e)?this.selectedTags=this.selectedTags.filter(l=>l!==e):this.selectedTags=[...this.selectedTags,e]},filterByTags(e){return this.selectedTags.length===0?e:e.filter(l=>this.selectedTags.some(i=>l.tags?.includes(i)))},render(){if(!this.groups)return g.SPINNER;const e=this.filterByTags(this.groups),l=e.filter(t=>t.featured),i=e.filter(t=>!t.featured);return s\`
    ...
    \`}};
`,mimeType:"text/javascript"},"/views/group.js":{content:`import r from"/$app/types/index.js";import{html as t}from"/npm/lit-html";export default{properties:{group:r.object(),featured:r.boolean({defaultValue:!1}),onClick:r.function({attribute:!1})},handleCardClick(e){e.target.closest(".whatsapp-btn")||this.onClick&&this.onClick(this.group)},render(){if(!this.group)return null;const e=this.group,l=e.recommended||e.viewCount>=100,s=e.tags?.length>0;return this.featured?t\`
        <div
          class="bg-white border-3 border-black rounded-2xl overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all cursor-pointer"
...
`,mimeType:"text/javascript"},"/views/group-detail-view.js":{content:`import t from"/$app/types/index.js";import s from"/$app.js";import{html as i}from"/npm/lit-html";import{getCategoryColor as o,NBS as a}from"./utils.js";import"./detail-hero.js";import"./detail-info-card.js";export default{dataQuery:!0,properties:{group:t.object({attribute:!1}),userId:t.string({defaultValue:"guest"}),currentUser:t.object({sync:s.Model.users,query:e=>({id:e.userId,includes:["likedGroups"]}),dependsOn:["userId"]}),showAuthPrompt:t.boolean({defaultValue:!1}),authPromptMessage:t.string({defaultValue:""}),showAuthModal:t.boolean({defaultValue:!1})},async connected(){this.userId=s.Auth.isAuthenticated?s.Auth.currentUserId:"guest"},dataLoaded({row:e}){e?.name&&s.Router.setTitle(e.name)},isLiked(){return!this.currentUser||!this.group?!1:this.currentUser.likedGroups?.some(e=>e.id===this.group.id)||!1},async handleLikeToggle(){const e=this.group;!e||!this.currentUser||(this.isLiked()?this.currentUser.likedGroups=this.currentUser.likedGroups.filter(r=>r.id!==e.id):this.currentUser.likedGroups=[...this.currentUser.likedGroups,{id:e.id}],await s.Model.users.edit(this.currentUser))},render(){const e=this.group;if(!e)return a.SPINNER;const r=this.isLiked();return i\`
    ...
    \`}};
`,mimeType:"text/javascript"},"/views/guides-view.js":{content:`import r from"/$app/types/index.js";import a from"/$app.js";import{html as s}from"/npm/lit-html";import{NBS as d}from"./utils.js";const{brand:u}=a.settings;export default{dataQuery:!0,properties:{guides:r.array(),selectedType:r.string({defaultValue:"all"})},goToGuide(t){a.Router.go("guide-detail",{slug:t.slug})},getFilteredGuides(){let t=this.guides||[];return this.selectedType!=="all"&&(t=t.filter(l=>l.guideType===this.selectedType)),t},render(){if(!this.guides)return d.SPINNER;const t=this.guides.filter(e=>e.featured),l=this.getFilteredGuides();return s\`
      <div class="p-4 sm:p-6 space-y-6 pb-24">
        <!-- Mobile Header with branding -->
        <header class="md:hidden flex items-center justify-between">
          <view-logo></view-logo>
    ...
    \`}};
`,mimeType:"text/javascript"},"/views/events-view.js":{content:`import n from"/$app/types/index.js";import o from"/$app.js";import{html as r}from"/npm/lit-html";import{CATEGORIES as p,getCategoryColor as d,NBS as g,PLACE_CATEGORIES as x}from"./utils.js";const{brand:f}=o.settings,b=["all",...x];export default{properties:{events:n.array({sync:o.Model.events,query:{}}),selectedFilter:n.string({defaultValue:"upcoming"}),selectedCategory:n.string({defaultValue:"all"})},goToEvent(t){o.Router.go("event-detail",{slug:t.slug})},setCategory(t){this.selectedCategory=t},filterByCategory(t){return this.selectedCategory==="all"?t:t.filter(s=>s.category===this.selectedCategory)},getUpcomingEvents(){const t=new Date().toISOString().split("T")[0];return this.filterByCategory(this.events||[]).filter(a=>a.date>=t).sort((a,e)=>new Date(a.date)-new Date(e.date))},getThisWeekEvents(){const t=new Date,s=new Date(t);s.setDate(t.getDate()+7);const a=t.toISOString().split("T")[0],e=s.toISOString().split("T")[0];return this.filterByCategory(this.events||[]).filter(l=>l.date>=a&&l.date<=e).sort((l,c)=>new Date(l.date)-new Date(c.date))},getRecurringEvents(){return this.filterByCategory(this.events||[]).filter(s=>s.isRecurring)},formatDate(t){return new Date(t).toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric"})},render(){if(!this.events)return g.SPINNER;const t=this.getUpcomingEvents(),s=this.getThisWeekEvents(),a=this.getRecurringEvents();return r\`
      <div class="p-4 sm:p-6 space-y-6 pb-24">
        <!-- Mobile Header with branding -->
        <header class="md:hidden flex items-center justify-between">
          <view-logo></view-logo>
        ...
        <div class="overflow-hidden -mx-4 sm:-mx-6">
          <div class="flex gap-2 overflow-x-auto pb-2 flex-nowrap px-4 sm:px-6">
            \${b.map(e=>{const i=this.selectedCategory===e,l=p[e]||{icon:"\\u{1F4CD}",color:"gray-200"};return r\`
                <button
                  @click=\${()=>this.setCategory(e)}
                  class="flex-shrink-0 px-3 py-1.5 border-2 border-black rounded-lg font-bold text-xs transition-all \${i?\`bg-\${l.color} shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]\`:"bg-white hover:bg-gray-100"}"
                >
                  \${l.icon} \${o.i18n?.t?.(\`categories.\${e}\`)||e}
                </button>
              \`})}
          </div>
        </div>
                  ...
                  \${s.slice(0,6).map(e=>r\`
                      ...
                      >
                        <div class="relative h-32 bg-gray-200">
                          ...
                          <div class="absolute top-2 left-2">
                            <span
                              class="px-2 py-0.5 \${d(e.category)} border-2 border-black rounded font-bold text-[10px] uppercase"
                            >
                              \${e.category}
                            </span>
                          </div>
                      ...
                      >
                        ...
                        <div class="flex-1 min-w-0">
                          <div class="flex items-center gap-2 mb-1">
                            <span
                              class="px-2 py-0.5 \${d(e.category)} border border-black rounded font-bold text-[9px] uppercase"
                            >
                              \${e.category}
                            </span>
                            <span
...
`,mimeType:"text/css"},"/$app/uix/layout/card.js":{content:`import e from"/$app/types/index.js";import{html as t}from"/npm/lit-html";export default{extends:"uix-container",i18n:{},style:!0,shadow:!0,properties:{borderWidth:e.string({defaultValue:"1",enum:["none","1","2","3"]}),borderStyle:e.string({defaultValue:"solid",enum:["solid","dashed","dotted"]}),shadow:e.string({defaultValue:"none",enum:["none","sm","md","lg"]}),hover:e.boolean({defaultValue:!1}),gap:e.string({defaultValue:"md",enum:["none","xs","sm","md","lg","xl"]})},render(){return t\`
      <slot name="header" part="header"></slot>
      <slot part="body"><slot></slot></slot>
      
      <slot part="footer" name="footer"></slot>
    \`}};
`,mimeType:"text/javascript"},"/$app/uix/layout/container.js":{content:`import e from"/$app/types/index.js";export default{style:!0,properties:{padding:e.string({defaultValue:"md",enum:["none","sm","md","lg"]}),overflow:e.string({enum:["visible","hidden","auto","scroll"]}),variant:e.string({defaultValue:"default",enum:["default","filled","outlined","elevated"]})}};
